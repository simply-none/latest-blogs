    ...
    t.r(e),
      ...
      (window.$docsify.plugins = (window.$docsify.plugins || []).concat(
        function (o, e) {
          ...
          <div style="float: left;"><a href="https://docsify.js.org" target="_blank" style="color: #afafaf; font-weight: normal; text-decoration: none;">博客模板通过<span style="color: #4ab1f6;">docsify</span>制作</a></div>
          <div style="float: right; color: #afafaf;">${t} ${n}</div>
