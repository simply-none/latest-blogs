...
layout: home
titleTemplate: 记录工作、居家过程中学习到的知识点与一些人生思考

hero:
  name: 璎耜
  # text: 记录工作、居家过程中学习到的知识点与一些人生思考
  tagline: 记录工作、居家过程中学习到的知识点与一些人生思考
  image:
    src: /logo.png
  actions:
    - theme: brand
      text: 开始
      link: /usage-frame/README
    - theme: alt
      text: 在 GitHub 上查看
      link: https://github.com/simply-none/latest-blogs/
